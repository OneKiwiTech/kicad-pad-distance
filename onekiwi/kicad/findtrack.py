...
class FindNet:
    ...
    def get_length(self):
        for i, nettrack in enumerate(self.data.items):
            ...
            self.data.items[i].track_length = sum_track_length/1000000 #mm
            #self.data.items[i].track_length = sum_track_length
            ...
            self.data.items[i].total_length = (sum_track_length/1000000) + sum_via_length + sum_hole_length
            #self.data.items[i].total_length = sum_track_length/1000000 + sum_via_length + sum_hole_length
